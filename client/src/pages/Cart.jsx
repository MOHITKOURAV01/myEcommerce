...
export default function Cart() {
  const { items, coupon, totals, isLoading, updateQty, removeFromCart, applyCoupon, removeCoupon } = useCart();
  ...
  const total = (totals?.total || 0) + shipping + tax;

  if (isLoading) return <LoadingSpinner text="Counting your books..." />;
            ...
            <div key={item.book._id} className="clay-card" style={{ display: 'flex', gap: '24px', alignItems: 'center' }}>
               ...
               <div style={{ flex: 1 }}>
                   ...
                   <div className="flex-between" style={{ justifyContent: 'flex-start', gap: '32px' }}>
                       <span className="price-current">₹{item.book.price}</span>
        ...
        <div style={{ flex: '1', position: 'sticky', top: '100px' }}>
            <div className="wood-panel" style={{ padding: '32px' }}>
                ...
                <div className="flex-between" style={{ marginBottom: '32px' }}>
                    ...
                    <span className="price-current" style={{ fontSize: '36px' }}>₹{total}</span>
                </div>
