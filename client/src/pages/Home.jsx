      ...
      <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
        <div className="container grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <motion.div
            ...
            className="z-10"
          >
            <div className="inline-flex items-center gap-3 bg-forest/10 border border-forest/20 px-4 py-2 rounded-full mb-6">
              <span className="w-2 h-2 bg-mint rounded-full animate-pulse" />
              <span className="text-[10px] font-black uppercase tracking-[3px] text-mint">Archaic Collection 2024</span>
            </div>

            <h1 className="font-fredoka text-7xl md:text-8xl text-cream mb-6 leading-[0.9]">
              Curating <br />
              <span className="text-primary italic">The Soul's</span> <br />
              Library
            </h1>

            <p className="text-xl text-textMed mb-10 max-w-lg leading-relaxed">
              Step into a sanctuary where books aren't just paper, but prescriptions for the modern heart.
            </p>

            <div className="flex flex-wrap gap-6">
              <button onClick={() => navigate('/discover')} className="clay-btn btn-primary btn-lg shadow-[0_0_40px_rgba(46,125,50,0.3)]">
                Enter the Gallery <FaArrowRight />
              </button>
              <button onClick={() => navigate('/paths')} className="btn-ghost !text-cream font-black uppercase tracking-widest text-xs border-b-2 border-primary pb-1">
                Choose a Reading Path
              </button>
            </div>

            <div className="flex gap-12 mt-16 pt-8 border-t border-borderWarm/30">
              <div>
                <p className="font-fredoka text-4xl text-primary">1.2k+</p>
                <p className="text-[10px] font-black uppercase tracking-widest text-textMuted">Relics Found</p>
              </div>
              <div>
                <p className="font-fredoka text-4xl text-mint">4.9/5</p>
                <p className="text-[10px] font-black uppercase tracking-widest text-textMuted">Soul Rating</p>
              </div>
            </div>
          </motion.div>
